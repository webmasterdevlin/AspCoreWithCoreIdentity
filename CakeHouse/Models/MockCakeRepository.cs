...
namespace CakeHouse.Models
{
    public class MockCakeRepository : ICakeRepository
    {
        ...
        {
            return _cakes.FirstOrDefault(c => c.Id == cakeId);
        }
    }
}
